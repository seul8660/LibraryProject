...
public class Builder {
    ...
    public Builder thumbTextColor(@ColorInt int thumbTextColor) {
     ...
     /**
     * set the seek bar's thumb's text Unit.
     *
     * @param thumbTextUnit textUnit
     */
    public Builder thumbTextColor(String thumbTextUnit) {
        this.thumbTextUnit = thumbTextUnit;
        return this;
    }
